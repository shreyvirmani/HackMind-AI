...
class WorkflowController:
    ...
    def build_project(self, idea: str):
        ...
        try:
            result["research"] = research_controller.generate_research(
                roadmap_json
            )
        ...
        try:
            result["judge"] = judge_controller.evaluate_project(
                roadmap_json
            )
        ...
        try:
            result["pitch_deck"] = pitch_deck_controller.generate_pitch_deck(
                roadmap_json
            )
